...
int main(int argc, char **argv) {
  ...
  ///assing the ground sensors to divice variables and enable the ground sensors
  ...
  while (wb_robot_step(TIME_STEP) != -1) {
    ...
    double base_speed = 1.2; // forward speed
     
    double left_speed = base_speed + rotation;
    double right_speed = base_speed - rotation; 
